...
var defaults = {
	...
	monthNames: ['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Setiembre','Octubre','Noviembre','Deciembre'],
...
function Calendar(element, options, eventSources) {
	...
	-----------------------------------------------------------------------------*/
	// XXX
	function saveSteps(inc) {
		if(!window.calendarUpdatingSteps) {
			oldVal = window.calendarSteps || 0
			oldVal += inc || 0
			window.calendarSteps = oldVal
		}
	}
					...
					if (buttonName == 'title') {
						...
						if (calendar[buttonName]) {
							...
							buttonClick = function() {
								...
								// XXX
								oldView = Session.get('calendarView');
								if( oldView != buttonName ) {
									Session.set('calendarView', buttonName);
									window.calendarSteps = null
								}
