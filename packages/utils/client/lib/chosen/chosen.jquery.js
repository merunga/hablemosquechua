...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.setup = function() {
      ...
      if (!this.allow_custom_value) {
        return this.allow_custom_value = this.form_field_jq.hasClass("chosen-custom-value");
      }
    };
    ...
    Chosen.prototype.field_invalid = function(evt) {
      ...
      }).bind("change.chosen-valid", function(evt) {
    ...
    Chosen.prototype.field_valid = function(evt) {
      if (this.form_field.validity && this.form_field.validity.valid) {
        return this.form_field_jq.hide().unbind("change.chosen-valid");
      }
    };
    ...
    Chosen.prototype.register_observers = function() {
      ...
      this.form_field_jq.bind("invalid.chosen", function(evt) {
        _this.field_invalid(evt);
      });
